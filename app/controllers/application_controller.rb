class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.permit(:sign_up, keys: [:full_name, :is_pastor, :is_message_believer, :city])
    devise_parameter_sanitizer.permit(:account_update, keys: [:full_name, :is_pastor, :is_message_believer, :city])
  end
